...
def Optimisation(participant, Masse_centre, trial_name, vide_name, frame, initial_guess, min_energie):  # main
    ...
    return (
        ...
        dict_fixed_params,
        sol.get("f"),
        solver.stats().get("return_status"),
        solver.stats().get("t_wall_total"),
    )
...
k1 = np.random.random(100) * (
    (5402.192174502561 - 0.027018638307020674) + (5402.192174502561 - 0.027018638307020674) / 2
)
k2 = np.random.random(100) * ((4686.689399935946 - 3864.487805284511) + (4686.689399935946 - 3864.487805284511) / 2)
k3 = np.random.random(100) * (
    (2270.0291466972685 - 0.00314300864526305) + (2270.0291466972685 - 0.00314300864526305) / 2
)
...
k_oblique1 = np.random.random(100) * (
    (2656.430196271891 - 556.0482761816891) + (2656.430196271891 - 556.0482761816891) / 2
)
k_oblique2 = np.random.random(100) * (
    (8515.608811068023 - 270.7003279549531) + (8515.608811068023 - 270.7003279549531) / 2
)
k_oblique3 = np.random.random(100) * (
    (13181.213854236343 - 628.9156673674759) + (13181.213854236343 - 628.9156673674759) / 2
)
k_oblique4 = np.random.random(100) * (
    (27596.61967037554 - 4643.7127319010515) + (27596.61967037554 - 4643.7127319010515) / 2
)
print(k1)
print(k2)
print(k3)
...
for multi in range(0, nb_essais_multi):
    ...
    (
        ...
        status,
        temps_optim,
    ) = Optimisation(participant, Masse_centre, trial_name, vide_name, frame, initial_guess, min_energie)
