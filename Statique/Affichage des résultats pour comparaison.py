...
liste_k_name = [
    "k1 coin horizontal",
    "k2 cadre/toile horizontal",
    "k3 coin vertical",
    "k4 cadre/toile vertical",
    "k5 bord horizontal",
    "k6 horizontal",
    "k7 bord vertical",
    "k8 vertical",
...
for i in range(0, len(statu_multi)):
    if (statu_multi[i] == "Solve_Succeeded" or statu_multi[i] == "Solved_To_Acceptable_Level") and f_multi[
        i
    ] < f_35essais:
        print(f_multi[i])
        print("   indice : " + str(i))
