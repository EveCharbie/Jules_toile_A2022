...
L'objectif :
-minimiser la résultante des forces en chacun des n*m points des 2 essais
...
-les coordonnées des n*m points des 2 essais
...
# ESSAI 1
F_totale1, F_point1 = Calcul_Pt_F_verif(
    Solution[17:422], Pt_ancrage[0], dict_fixed_params, Solution[:12], ind_masse[0], Solution[12:17]
)
...
labels1 = labels[0]
# ESSAI 2
F_totale2, F_point2 = Calcul_Pt_F_verif(
    Solution[427:832], Pt_ancrage[1], dict_fixed_params, Solution[:12], ind_masse[1], Solution[422:427]
)
...
ax.plot(
    Pt_collecte1[0, label_masse],
    Pt_collecte1[1, label_masse],
    Pt_collecte1[2, label_masse],
    "og",
    label="Point collecte le plus bas " + labels1[label_masse],
)
plt.legend()
...
ax.plot(
    ...
    Pt2[ind_masse[1], 2],
    "+y",
    label="Point optimisés le plus bas d'indice " + str(ind_masse[1]),
)
ax.plot(Pt_collecte2[0, :], Pt_collecte2[1, :], Pt_collecte2[2, :], ".b", label="Points collecte")
label_masse = labels2.index("t" + str(ind_masse[1]))
ax.plot(
    Pt_collecte2[0, label_masse],
    Pt_collecte2[1, label_masse],
    Pt_collecte2[2, label_masse],
    "og",
    label="Point collecte le plus bas " + labels2[label_masse],
)
# plt.legend()
# plt.title('Essai d\'optimisation améliorée : \n Comparaison de l\'essai statique ' + trial_name + ' \n avec les positions optimisées')
...
print(
    ...
    + str(trial_name[0])
    + " = "
    + str(erreur_position1)
    + " m"
    + " // "
    + str(trial_name[1])
    + " = "
    + str(erreur_position2)
    + " m"
)
print(
    "-Erreur sur la force-  "
