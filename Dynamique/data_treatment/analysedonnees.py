...
def Force_point(
    F_spring, F_spring_croix, F_masses, F_amortissement
...
def Bouts_ressort_collecte(Pt_interpolés, Pt_ancrage_collecte, label_ancrage, Masse_centre):
    ...
    dict_fixed_params = Param_fixe(Masse_centre)
    Pt_ancrage_collecte_interpolés = Interpolation_ancrage(
        Pt_ancrage_collecte, label_ancrage
    )  # renvoie les pt dancrages mais avec des nan si il y a rien (48*3)
